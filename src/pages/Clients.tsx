...
const clients: ClientCase[] = [
  ...
  },
  {
    ...
    industry: "jewellery",
    services: ["performance"],
    metric: "8,95,831 Impressions",
    result: "Google + Meta Full-Funnel Growth",
    ...
    challenge: "Evermore was spending 76% of Google budget on Search with a AED 2,023 cost/conversion while the best-performing campaign (P-MAX) sat at AED 40/day. Conversion goals were misaligned — 2 of 3 campaigns optimised for Add to Cart instead of Purchase. On Meta, budget was spread across 13 campaigns with no unified funnel — traffic, catalogue, retargeting, and WhatsApp campaigns running in silos. AED 1,59,490 in Google cart value and 55 Meta add-to-carts had no retargeting layer to convert them.",
    strategy: "Conducted a full Google Ads audit — identified keyword gap (80% of 168K pool untapped), conversion goal misalignment, and broad match bleeding. Recommended budget reallocation toward P-MAX and Shopping. On Meta, ran parallel campaigns: traffic (2,48,059 impressions, 9,258 clicks), retargeting via Statement Gifting & Event Remarketing campaigns, catalogue campaigns, and a dedicated WhatsApp outreach campaign (27 messaging connections). Designed full-funnel structure: Awareness → Conversion → Retargeting across both platforms.",
    results: [
      "8,95,831 combined impressions across Google & Meta",
      "23,913 total clicks at blended AED 0.63 CPC",
      "P-MAX delivered AED 165 cost/conv — 12x better than Search",
      "AED 1,59,490 in Google cart value generated",
      "55 Meta add-to-carts across catalogue campaigns",
      "27 WhatsApp conversations via Meta offer campaign",
      "9,243 Meta landing page views at AED 0.32 CPC",
      "Full audit delivered — keyword, audience & budget gaps mapped"
    ],
    logo: evermoreLogo,
    logoSize: "wide",
    platforms: ["Google Ads", "Meta Ads"],
