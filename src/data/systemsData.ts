...
export const systemsData: SystemDef[] = [
  // ── 1. LEAD GENERATION ──
  {
    ...
    stages: [
      ...
      {
        step: "Step 5",
        title: "WhatsApp + email nurturing (AIDA framework)",
        pills: ["WhatsApp Business API", "Klaviyo / Mailchimp", "AIDA sequences"],
        checks: [
          "Attention: instant WhatsApp acknowledgement within 60 seconds of opt-in",
          "Interest: educational content tailored to lead's industry & intent",
          "Desire: case studies, testimonials and proof points to build conviction",
          "Action: clear booking CTA in every touchpoint moving lead toward a call",
          "Re-engagement trigger if lead goes cold after 3 days",
        ],
        output: "Warmed, AIDA-nurtured lead with high booking intent",
      },
      {
        step: "Step 6",
  ...
  // ── 2. E-COMMERCE ──
  {
    ...
    stages: [
      ...
      {
        step: "Step 4",
        title: "Lifecycle nurture: Email, WhatsApp, SMS (AIDA framework)",
        pills: ["Klaviyo", "WhatsApp Business API", "Wati / Interakt", "AIDA flows"],
        checks: [
          "Attention: welcome + browse-abandon flows that hook new visitors",
          "Interest: educational + UGC content matched to category and behaviour",
          "Desire: cart-abandon, social proof and bundle nudges to push intent",
          "Action: post-purchase, replenishment and win-back sequences that close",
          "RFM-based segmentation (VIP, loyal, at-risk, dormant) with weekly calendar",
        ],
        output: "30–40% revenue from owned channels via AIDA-driven retention",
      },
      {
        step: "Step 5",
  ...
  // ── 3. CREATIVE SHOOT ──
  {
    ...
    stages: [
      ...
      {
        step: "Step 2",
        title: "Pre-production (every detail approved before shoot day)",
        pills: ["Mood boards", "Shot list", "Casting", "Script & wardrobe"],
        checks: [
          "Mood board approved by client (look, lighting, palette) — no surprises on set",
          "Detailed shot list signed off and mapped to ad/PDP requirements",
          "Scripts and storyboards approved in writing before talent is booked",
          "Casting: models, actors, hands and talent — auditioned and approved with backups",
          "Wardrobe, props and locations approved + production schedule circulated 48h prior",
        ],
        output: "Pre-production locked & signed off — zero ambiguity for shoot day",
      },
      {
        step: "Step 3",
        title: "Shoot day SOPs (live client review, no rework)",
        pills: ["Call sheet", "On-set monitor review", "Backup shots"],
        checks: [
          "Pre-shoot setup check: lights, lenses, props, wardrobe verified against brief",
          "Live monitor review with client/producer per setup — sign-off before moving on",
          "Every approved shot list item ticked off and reviewed before wrap",
          "Behind-the-scenes captured for organic/social use",
          "Files backed up on-set to two drives + cloud upload",
        ],
        output: "Approved raw footage + stills, no reshoots required",
      },
      {
        step: "Step 4",
        title: "Post-production (approval gates at every stage)",
        pills: ["Photoshop", "Premiere / DaVinci", "After Effects", "Frame.io"],
        checks: [
          "Selects shared with client within 48h of wrap for first approval",
          "Edit cut shared for sign-off before colour, audio and graphics finalised",
          "Retouching, colour and audio matched to brand guidelines + reference",
          "Cut-downs (9:16, 1:1, 16:9) and static variants reviewed before final export",
          "Two rounds of revision built in — final delivery only after written approval",
        ],
        output: "Final, on-brand assets — fully approved and ready to deploy",
      },
      {
        step: "Step 5",
